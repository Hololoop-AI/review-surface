// Generates skills/review-surface/SKILL.md from the shared no-args home output so the
// installable skill never drifts from what `review-surface` (and the SessionStart hook) print.
//
...
const target = new URL("../skills/review-surface/SKILL.md", import.meta.url);
...
if (check) {
  ...
  await mkdir(new URL("../skills/review-surface/", import.meta.url), { recursive: true });
