---
name: review-surface-design
description: Use this skill to generate well-branded interfaces and assets for Review Surface, either for production or throwaway prototypes/mocks/etc. Contains essential design guidelines, colors, type, fonts, assets, and UI kit components for prototyping.
user-invocable: true
metadata:
  internal: true
---
...
- `assets/` — wordmark, review-surface-mark icon, flow diagram SVG
- `preview/` — Design-System-tab specimen cards (one concept per card)
- `ui_kits/editor/` — clickable React recreation of the Review Surface chrome
...
4. Reference `assets/review-surface-wordmark.svg` for the brand mark; do not redraw it.
