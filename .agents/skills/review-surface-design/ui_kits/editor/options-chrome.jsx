...
// Each renders a small, static Review Surface Editor chrome at artboard scale.
...
function Brand() {
  return (
    <div style={mc.brand}>
      <span style={mc.brandMark}>Review Surface</span>
...
function ArtifactBody({ note }) {
  return (
    <div style={mc.artifact}>
      ...
      <p style={mc.artLede}>Review Surface opens an agent-generated HTML artifact in a local browser, lets you pinpoint elements, and ships your feedback back to the agent.</p>
      {note}
    </div>
  );
}
