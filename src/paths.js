...
// Address the server binds to (REVIEW_SURFACE_HOST). Defaults to loopback. A wildcard value
...
// Hostname written into the session URLs the server generates (REVIEW_SURFACE_LINK_HOST).
...
// loopback names and the resolved bind/link host, set via REVIEW_SURFACE_ALLOWED_HOSTS
...
export function stateDir() {
  return process.env.REVIEW_SURFACE_STATE_DIR || path.join(os.homedir(), ".review-surface");
}
