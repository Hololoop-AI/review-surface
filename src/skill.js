...
export const SKILL_DESCRIPTION =
  ...
  "annotate and send feedback on, using the review-surface CLI. Use when about to give a plan, " +
...
function skillCommandText(text) {
  return text.replaceAll("`review-surface", "`npx -y review-surface");
}
...
/**
 * Render the installable SKILL.md for the review-surface skill. The body mirrors what
 * `review-surface` prints with no arguments (minus live session state), while the
...
export function createSkillMarkdown() {
  const home = createHomeOutput({ bin: "review-surface", sessions: [], includeSessions: false, agent: "static" });
