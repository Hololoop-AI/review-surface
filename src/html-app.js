...
// (https://ht-ml.app), a third-party hosting service not part of Review Surface, and return a visitable
 ...
 * @param {string} [options.apiUrl] Override the API base (defaults to REVIEW_SURFACE_HTML_APP_API_URL or ht-ml.app).
