...
`review-surface share` publishes to [ht-ml.app](https://ht-ml.app) by default. Set
`REVIEW_SURFACE_HTML_APP_API_URL` to point `share` at a backend you control instead.
...
```
POST {REVIEW_SURFACE_HTML_APP_API_URL}/v1/sites
